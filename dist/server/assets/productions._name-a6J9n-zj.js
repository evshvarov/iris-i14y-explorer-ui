...
import { t as Route } from "./productions._name-TzjHxFCU.js";
...
function ProductionDetailContent() {
	...
	const updateMut = useMutation({
		mutationFn: (opts = {}) => apiFetch(`/productions/${encoded}/update?timeout=10${opts.force ? "&force=true" : ""}`, { method: "POST" }),
		onSuccess: (r) => {
			toast.success(`Apply changes ${r.changed ? "issued" : "no-op"} — ${r.runtime?.stateLabel ?? "updated"}`);
			invalidateRuntime();
		},
		onError: (e) => {
			const msg = e.message || "";
			if (/\b409\b/.test(msg)) toast.error("Conflict applying changes. Retry with Force?", { action: {
				label: "Force apply",
				onClick: () => updateMut.mutate({ force: true })
			} });
			else toast.error(`Apply failed: ${msg}`);
		}
	});
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(PageHeader, {
		...
		actions: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("button", {
					...
					children: [updateMut.isPending ? /* @__PURE__ */ jsx(RefreshCw, { className: "size-3.5 animate-spin" }) : /* @__PURE__ */ jsx(GitPullRequestArrow, { className: "size-3.5" }), "Apply changes"]
				}),
				/* @__PURE__ */ jsx("button", {
		...
		children: [/* @__PURE__ */ jsxs("aside", {
			...
			children: [
				activeTab === "overview" ? /* @__PURE__ */ jsx(ProductionKPIs, { productionName: name }) : null,
				activeTab === "summary" ? /* @__PURE__ */ jsxs("div", {
					className: "space-y-6",
					children: [
				...
				activeTab === "schematic" ? /* @__PURE__ */ jsxs(Fragment, { children: [comps.error ? /* @__PURE__ */ jsx(ErrorPanel, {
					error: comps.error,
					label: "components"
				...
				activeTab === "graph" ? graph.isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-40 rounded-lg" }) : graph.error ? /* @__PURE__ */ jsx(ErrorPanel, {
					error: graph.error,
					label: "graph"
				...
				activeTab === "analysis" ? analysis.isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-40 rounded-lg" }) : analysis.error ? /* @__PURE__ */ jsx(ErrorPanel, {
				...
				activeTab === "rules" ? analysis.isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-40 rounded-lg" }) : /* @__PURE__ */ jsxs("div", {
					className: "space-y-8",
					children: [/* @__PURE__ */ jsx(RulesSection, {
				...
				activeTab === "bpl" ? analysis.isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-40 rounded-lg" }) : /* @__PURE__ */ jsx(ProcessesSection, {
					processes: analysis.data?.businessProcesses ?? [],
					explanations: analysis.data?.businessProcessExplanations ?? []
				}) : null,
				activeTab === "explanations" ? analysis.isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-40 rounded-lg" }) : /* @__PURE__ */ jsx(ExplanationsSection, { explanations: analysis.data?.componentExplanations ?? [] }) : null,
				activeTab === "messages" ? /* @__PURE__ */ jsxs("div", {
					className: "bg-card ring-1 ring-black/5 rounded-lg overflow-hidden",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between px-4 py-2 border-b border-black/5",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "text-xs font-mono text-muted-foreground uppercase tracking-widest",
							children: ["Runtime messages · ", name]
						}), /* @__PURE__ */ jsx(Link, {
							to: "/messages",
							search: { productionName: name },
							className: "text-[11px] text-iris-brand hover:underline",
							children: "Open full explorer ↗"
						})]
					}), /* @__PURE__ */ jsx("iframe", {
				...
				activeTab === "logs" ? /* @__PURE__ */ jsx(LogsPanel, { productionName: name }) : null,
				activeTab === "ask" ? /* @__PURE__ */ jsx(AIAskPanel, {
					productionName: name,
					encoded,
					componentNames: components.map((c) => c.name ?? c.className ?? "").filter(Boolean)
				}) : null
...
function AISummaryPanel({ productionName, encoded, componentNames }) {
		...
		children: [
			...
			result ? /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					result.summary ? /* @__PURE__ */ jsx(MarkdownContent, {
...
function AIAskPanel({ productionName, encoded, componentNames }) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "space-y-4",
				children: history.map((r, idx) => /* @__PURE__ */ jsx(AIAskResult, {
					result: r,
					componentNames
				}, idx))
			})
...
function AIAskResult({ result, componentNames }) {
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [
			...
			result.answer ? /* @__PURE__ */ jsx(MarkdownContent, {
				linkComponents: componentNames,
