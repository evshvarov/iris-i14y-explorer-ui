...
function LogsPanel({ productionName, title }) {
	...
	const productionNames = (useQuery({
	...
	const componentQueries = useQueries({ queries: productionNames.map((name) => ({
		queryKey: ["production-components", name],
		queryFn: () => apiFetch(`/productions/${encodeURIComponent(name)}/components`),
		enabled: enableLookup,
		staleTime: 300 * 1e3,
		retry: 0
	})) });
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										e.source ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", { children: "·" }), (() => {
											const prod = productionName ?? e.productionName ?? responseProductionName ?? sourceToProduction.get(e.source);
											return prod ? /* @__PURE__ */ jsx(Link, {
												to: "/productions/$name/components/$componentName",
												params: {
													name: prod,
													componentName: e.source
												},
										...
										!productionName && e.productionName ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", { children: "·" }), /* @__PURE__ */ jsx(Link, {
											to: "/productions/$name",
