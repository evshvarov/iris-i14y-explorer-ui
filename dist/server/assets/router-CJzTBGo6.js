...
import { t as Route$9 } from "./messages.index-DqzNRWgV.js";
import { t as Route$10 } from "./messages._id-Dr5G8sB4.js";
import { t as Route$11 } from "./productions._name-BpRDCmAf.js";
import { t as Route$12 } from "./productions._name.components._componentName-DpS_LpBw.js";
...
import { Activity, Boxes, FileCode2, MessageSquareText, PanelLeft, ScrollText, Settings2, X } from "lucide-react";
...
var styles_default = "/i14y-explorer-ui/assets/styles-CFcgIyXx.css";
//#endregion
...
function AppSidebar() {
	...
	return /* @__PURE__ */ jsxs(Sidebar, { children: [
		/* @__PURE__ */ jsxs(SidebarHeader, {
			className: "border-b h-14 flex-row items-center px-5",
			children: [/* @__PURE__ */ jsx("div", {
				className: "size-6 bg-iris-brand rounded flex items-center justify-center shrink-0",
				children: /* @__PURE__ */ jsx("div", { className: "size-2.5 bg-background rotate-45" })
			}), /* @__PURE__ */ jsx("span", {
				className: "ml-3 text-sm font-semibold tracking-tight uppercase",
				children: "IRIS Explainer"
			})]
		}),
		/* @__PURE__ */ jsxs(SidebarContent, {
			...
			children: [/* @__PURE__ */ jsxs(SidebarGroup, { children: [/* @__PURE__ */ jsx(SidebarGroupLabel, {
				...
				children: "Core"
			}), /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: core.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, {
				asChild: true,
			...
			}) }, item.url)) }) })] }), /* @__PURE__ */ jsxs(SidebarGroup, { children: [/* @__PURE__ */ jsx(SidebarGroupLabel, {
				className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-widest",
				children: "Exploration"
			}), /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: exploration.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, {
				asChild: true,
				isActive: isActive(item.url),
				children: /* @__PURE__ */ jsxs(Link, {
					to: item.url,
...
var Route$8 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Deterministic UI for the InterSystems IRIS Interoperability Production Explainer (i14y-aid) REST API."
			},
			{
				property: "og:title",
				content: "IRIS Interoperability Production Explainer"
			},
			{
			...
			{
				property: "og:image",
				content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1940fde9-637c-4b2e-9db8-03abbf131c73/id-preview-b9d2138e--75feb62f-6fe4-473f-8d20-7bdcf16e4dd8.lovable.app-1784017705338.png"
			},
			{
				name: "twitter:image",
				content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1940fde9-637c-4b2e-9db8-03abbf131c73/id-preview-b9d2138e--75feb62f-6fe4-473f-8d20-7bdcf16e4dd8.lovable.app-1784017705338.png"
...
function RootComponent() {
	...
	return /* @__PURE__ */ jsx(QueryClientProvider, {
		...
		children: /* @__PURE__ */ jsxs(SidebarProvider, { children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(AppSidebar, {}), /* @__PURE__ */ jsxs("main", {
				className: "flex-1 flex flex-col min-w-0",
				children: [/* @__PURE__ */ jsx("div", {
					className: "md:hidden h-12 border-b flex items-center px-4",
...
var $$splitComponentImporter$6 = () => import("./api-reference-B4anLJWs.js");
var Route$6 = createFileRoute("/api-reference")({
	head: () => ({ meta: [{ title: "API Reference — IRIS Explainer" }] }),
	component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
//#endregion
//#region src/routes/health.tsx
var $$splitComponentImporter$5 = () => import("./health-DIgkfoY7.js");
...
var $$splitComponentImporter$4 = () => import("./logs-DR9jq7x4.js");
var Route$4 = createFileRoute("/logs")({
...
var $$splitComponentImporter$3 = () => import("./messages-DiZHpErc.js");
var Route$3 = createFileRoute("/messages")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
//#endregion
...
var $$splitComponentImporter$1 = () => import("./settings-ssFsTvli.js");
...
var $$splitComponentImporter = () => import("./productions.index-B_B7PEeg.js");
...
var ApiReferenceRoute = Route$6.update({
	id: "/api-reference",
	path: "/api-reference",
	getParentRoute: () => Route$8
});
...
var LogsRoute = Route$4.update({
	id: "/logs",
	path: "/logs",
	getParentRoute: () => Route$8
});
var MessagesRoute = Route$3.update({
	id: "/messages",
	path: "/messages",
	getParentRoute: () => Route$8
});
...
var MessagesIndexRoute = Route$9.update({
	id: "/",
	path: "/",
	getParentRoute: () => MessagesRoute
});
var MessagesIdRoute = Route$10.update({
	id: "/$id",
	path: "/$id",
	getParentRoute: () => MessagesRoute
});
...
var ProductionsNameRoute = Route$11.update({
	id: "/$name",
	path: "/$name",
	getParentRoute: () => ProductionsRoute
});
var ProductionsNameComponentsComponentNameRoute = Route$12.update({
