...
import { t as Route } from "./messages.index-C_SMLvek.js";
...
function MessagesPage() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [search.embedded ? null : /* @__PURE__ */ jsx(PageHeader, {
				...
				listQuery.isLoading ? /* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: filteredByStatus.map((m) => {
							const label = m.statusLabel || m.statusName || statusNameByCode.get(String(m.status ?? "")) || m.status;
